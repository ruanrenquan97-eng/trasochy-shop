...
export default function ProductsPage() {
  ...
  const { data: dbSkinTypes } = useQuery({
    ...
    queryFn: () => api.get('/products/tags/skin-types'),
  }) as any;

  const { data: dbConcerns } = useQuery({
    queryKey: ['public-skin-concerns'],
    queryFn: () => api.get('/products/tags/skin-concerns'),
  }) as any;

  const SKIN_TYPES = dbSkinTypes || [];
  const CONCERNS = dbConcerns || [];
