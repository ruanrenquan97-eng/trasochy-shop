  ...
  return (
    <div className="max-w-sm mx-auto px-4 py-20">
      ...
      <form onSubmit={handleSubmit} className="card p-8 space-y-5">
        <div>
          <label className="text-xs text-stone-400 mb-2 block tracking-widest uppercase">Phone / Email</label>
          <input type="text" value={email} onChange={e => setEmail(e.target.value)} required placeholder="Phone number or Email" className="w-full border border-stone-300 px-4 py-3 text-sm focus:outline-none focus:border-stone-900" />
        </div>
        <div>
