...
exports.users = (0, sqlite_core_1.sqliteTable)('users', {
    ...
    level: (0, sqlite_core_1.text)('level', { enum: ['guest', 'member', 'silver', 'gold', 'diamond', 'staff', 'admin'] }).notNull().default('member'),
    ...
    proTestLimit: (0, sqlite_core_1.integer)('pro_test_limit').notNull().default(4),
...
exports.products = (0, sqlite_core_1.sqliteTable)('products', {
    ...
    dosageForms: (0, sqlite_core_1.text)('dosage_forms'), // JSON 数组: ["精华液", "面霜"]
...
exports.productPrices = (0, sqlite_core_1.sqliteTable)('product_prices', {
    id: (0, sqlite_core_1.integer)('id').primaryKey({ autoIncrement: true }),
    productId: (0, sqlite_core_1.integer)('product_id').notNull().references(() => exports.products.id),
    level: (0, sqlite_core_1.text)('level', { enum: ['guest', 'member', 'silver', 'gold', 'diamond'] }).notNull(),
...
exports.orders = (0, sqlite_core_1.sqliteTable)('orders', {
    ...
    trackingCompany: (0, sqlite_core_1.text)('tracking_company'),
...
// 临床报告表
exports.clinicalReports = (0, sqlite_core_1.sqliteTable)('clinical_reports', {
    id: (0, sqlite_core_1.integer)('id').primaryKey({ autoIncrement: true }),
    title: (0, sqlite_core_1.text)('title').notNull(),
    slug: (0, sqlite_core_1.text)('slug').notNull().unique(),
    summary: (0, sqlite_core_1.text)('summary'),
    coverImage: (0, sqlite_core_1.text)('cover_image'),
    pdfUrl: (0, sqlite_core_1.text)('pdf_url'), // 报告PDF链接
    status: (0, sqlite_core_1.text)('status', { enum: ['published', 'draft'] }).notNull().default('draft'),
    translations: (0, sqlite_core_1.text)('translations'), // JSON: { en: { title: '', summary: '' }, de: { ... } }
    publishedAt: (0, sqlite_core_1.integer)('published_at', { mode: 'timestamp' }),
    createdAt: (0, sqlite_core_1.integer)('created_at', { mode: 'timestamp' }).$defaultFn(() => new Date()),
    updatedAt: (0, sqlite_core_1.integer)('updated_at', { mode: 'timestamp' }).$defaultFn(() => new Date()),
});
// 皮肤检测记录表 (Baidu AI MVP)
exports.skinAnalysisRecords = (0, sqlite_core_1.sqliteTable)('skin_analysis_records', {
    id: (0, sqlite_core_1.integer)('id').primaryKey({ autoIncrement: true }),
    userId: (0, sqlite_core_1.integer)('user_id').references(() => exports.users.id),
    imageUrl: (0, sqlite_core_1.text)('image_url').notNull(),
    resultData: (0, sqlite_core_1.text)('result_data').notNull(), // JSON 格式保存百度API返回的原始结果
    type: (0, sqlite_core_1.text)('type', { enum: ['basic', 'pro'] }).notNull().default('basic'),
    createdAt: (0, sqlite_core_1.integer)('created_at', { mode: 'timestamp' }).$defaultFn(() => new Date()),
});
