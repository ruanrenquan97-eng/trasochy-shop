...
async function initDB() {
    ...
    CREATE TABLE IF NOT EXISTS product_prices (
      ...
      level TEXT NOT NULL CHECK(level IN ('guest','member','silver','gold')),
      price REAL NOT NULL,
      discount REAL
    );
  ...
  `);
    ...
    const tablesWithTranslations = ['categories', 'products', 'ingredients', 'articles'];
    ...
    // 迁移：给 products 表添加 Phase 2 字段
    const phase2ProductColumns = ['is_sample', 'is_story_page'];
