...
export const memberLevels = ['guest', 'member', 'silver', 'gold', 'staff', 'admin'] as const;
...
export const users = sqliteTable('users', {
  ...
  phone:       text('phone'),
  avatar:      text('avatar'),
  level:       text('level', { enum: ['guest', 'member', 'silver', 'gold', 'staff', 'admin'] }).notNull().default('member'),
...
export const productPrices = sqliteTable('product_prices', {
  id:          integer('id').primaryKey({ autoIncrement: true }),
  productId:   integer('product_id').notNull().references(() => products.id),
  level:       text('level', { enum: ['guest', 'member', 'silver', 'gold'] }).notNull(),
